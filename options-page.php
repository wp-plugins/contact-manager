...
<a style="text-decoration: none;" href="admin.php?page=contact-manager-form&amp;id=<?php echo $options['automatic_display_form_id']; ?>"><?php _e('Edit', 'contact-manager'); ?></a> | 
<a style="text-decoration: none;" href="admin.php?page=contact-manager-form&amp;id=<?php echo $options['automatic_display_form_id']; ?>&amp;action=delete"><?php _e('Delete', 'contact-manager'); ?></a></td></tr>
...
<a href="http://www.kleor-editions.com/contact-manager/#forms-creation"><?php _e('How to create a form?', 'contact-manager'); ?></a></p>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a href="http://www.kleor-editions.com/contact-manager/#captcha"><?php _e('How to display a CAPTCHA?', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description" style="vertical-align: 25%;"><a href="http://www.kleor-editions.com/contact-manager/#mailchimp"><?php _e('More informations', 'contact-manager'); ?></a>
<?php if (function_exists('commerce_manager_admin_menu')) { echo '<br />'.__('Leave this field blank to apply the Commerce Manager\'s option.', 'contact-manager'); } ?></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update', 'contact-manager'); ?>" /></td></tr>
</tbody></table>
...
<a style="text-decoration: none;" href="admin.php?page=commerce-manager-client-category&amp;id='.$options['sender_client_category_id'].'">'.__('Edit', 'contact-manager').'</a> | 
<a style="text-decoration: none;" href="admin.php?page=commerce-manager-client-category&amp;id='.$options['sender_client_category_id'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?></td></tr>
<?php } ?>
...
<a style="text-decoration: none;" href="admin.php?page=affiliation-manager-affiliate-category&amp;id='.$options['sender_affiliate_category_id'].'">'.__('Edit', 'contact-manager').'</a> | 
<a style="text-decoration: none;" href="admin.php?page=affiliation-manager-affiliate-category&amp;id='.$options['sender_affiliate_category_id'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?></td></tr>
<?php } ?>
...
<a style="text-decoration: none;" href="admin.php?page=membership-manager-member-area&amp;id='.$options['sender_members_areas'].'">'.__('Edit', 'contact-manager').'</a> | 
<a style="text-decoration: none;" href="admin.php?page=membership-manager-member-area&amp;id='.$options['sender_members_areas'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?><br />
...
<a style="text-decoration: none;" href="admin.php?page=membership-manager-member-category&amp;id='.$options['sender_member_category_id'].'">'.__('Edit', 'contact-manager').'</a> | 
<a style="text-decoration: none;" href="admin.php?page=membership-manager-member-category&amp;id='.$options['sender_member_category_id'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?></td></tr>
<?php } ?>
