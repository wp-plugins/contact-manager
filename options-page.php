...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#automatic-display"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
...
<a style="text-decoration: none;" <?php echo $ids_fields_links_markup; ?> href="admin.php?page=contact-manager-form&amp;id=<?php echo $options['automatic_display_form_id']; ?>&amp;action=delete"><?php _e('Delete', 'contact-manager'); ?></a></td></tr>
...
<a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#forms-creation"><?php _e('How to create a form?', 'contact-manager'); ?></a></p>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#captcha"><?php _e('How to display a CAPTCHA?', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#captcha"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#recaptcha"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description" style="vertical-align: 25%;"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#recaptcha"><?php _e('More informations', 'contact-manager'); ?></a>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><?php _e('You can encrypt the download URLs.', 'contact-manager'); ?> <a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#urls-encryption"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#aweber"><?php _e('Click here to read the instructions for integration.', 'contact-manager'); ?></a></span></td></tr>
</tbody></table>
</div>
...
<span class="description" style="vertical-align: 25%;"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#getresponse"><?php _e('More informations', 'contact-manager'); ?></a>
<?php if (function_exists('commerce_manager_admin_menu')) { echo '<br />'.__('Leave this field blank to apply the Commerce Manager\'s option.', 'contact-manager'); } ?></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update', 'contact-manager'); ?>" /></td></tr>
</tbody></table>
...
<span class="description" style="vertical-align: 25%;"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#mailchimp"><?php _e('More informations', 'contact-manager'); ?></a>
<?php if (function_exists('commerce_manager_admin_menu')) { echo '<br />'.__('Leave this field blank to apply the Commerce Manager\'s option.', 'contact-manager'); } ?></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update', 'contact-manager'); ?>" /></td></tr>
</tbody></table>
...
<span class="description" style="vertical-align: 25%;"><a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#sg-autorepondeur"><?php _e('More informations', 'contact-manager'); ?></a>
<?php if (function_exists('commerce_manager_admin_menu')) { echo '<br />'.__('Leave this field blank to apply the Commerce Manager\'s option.', 'contact-manager'); } ?></span></td></tr>
...
<?php if ((function_exists('commerce_manager_admin_menu')) && ($options['sender_client_category_id'] > 0)) { echo '<br />
<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=commerce-manager-client-category&amp;id='.$options['sender_client_category_id'].'">'.__('Edit', 'contact-manager').'</a> | 
<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=commerce-manager-client-category&amp;id='.$options['sender_client_category_id'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?></td></tr>
<?php } ?>
...
<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=affiliation-manager-affiliate-category&amp;id='.$options['sender_affiliate_category_id'].'">'.__('Edit', 'contact-manager').'</a> | 
<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=affiliation-manager-affiliate-category&amp;id='.$options['sender_affiliate_category_id'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?></td></tr>
<?php } ?>
...
<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=membership-manager-member-area&amp;id='.$options['sender_members_areas'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?><br />
...
<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=membership-manager-member-category&amp;id='.$options['sender_member_category_id'].'">'.__('Edit', 'contact-manager').'</a> | 
<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=membership-manager-member-category&amp;id='.$options['sender_member_category_id'].'&amp;action=delete">'.__('Delete', 'contact-manager').'</a>'; } ?></td></tr>
<?php } ?>
...
<span class="description"><?php _e('You can add custom instructions that will be executed just after the sending of a message.', 'contact-manager'); ?> <a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#custom-instructions"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update', 'contact-manager'); ?>" /></td></tr>
</tbody></table>
</div>
...
<span class="description"><?php _e('You can add custom instructions that will be executed just after the removal of a message.', 'contact-manager'); ?> <a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#custom-instructions"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php _e('Update', 'contact-manager'); ?>" /></td></tr>
</tbody></table>
</div>
...
<table class="form-table"><tbody>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><span class="description"><?php if (function_exists('affiliation_manager_admin_menu')) { _e('You can award a commission to the affiliate who referred a message.', 'contact-manager'); ?> <a <?php echo $documentations_links_markup; ?> href="http://www.kleor-editions.com/contact-manager/#affiliation"><?php _e('More informations', 'contact-manager'); ?></a><?php }
else { echo str_replace('<a', '<a '.$documentations_links_markup, __('To use affiliation, you must have installed and activated <a href="http://www.kleor-editions.com/affiliation-manager">Affiliation Manager</a>.', 'contact-manager')); } ?></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
