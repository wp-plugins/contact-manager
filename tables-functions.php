...
<span class="paging-input">'.($location == 'top' ? '<input class="current-page" title="'.__('Current page', 'contact-manager').'" type="text" name="paged" id="paged" value="'.$_GET['paged'].'" size="2" onchange="this.value = parseInt(this.value); window.location = \''.$url.'&amp;paged=\'+this.value;" />' : $_GET['paged']).' '.__('of', 'contact-manager').' <span class="total-pages">'.$max_paged.'</span></span>
