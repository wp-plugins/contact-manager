...
if ((isset($GLOBALS[$prefix.$name.'_error'])) && ($GLOBALS[$prefix.$field.'_error'] == 'unfilled_field')) {
$GLOBALS[$prefix.'unfilled_fields_error'] = contact_form_data('unfilled_fields_message'); $GLOBALS['form_error'] = 'yes'; } } }
foreach ($GLOBALS[$prefix.'patterns'] as $field => $pattern) {
if ((!isset($GLOBALS[$prefix.'invalid_fields_error'])) || ($GLOBALS[$prefix.'invalid_fields_error'] == '')) {
if ((isset($GLOBALS[$prefix.$name.'_error'])) && ($GLOBALS[$prefix.$field.'_error'] == 'invalid_field')) {
