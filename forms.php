...
if ((isset($_POST[$prefix.'submit'])) && (!isset($GLOBALS[$prefix.'processed']))) {
...
return '<span id="'.$prefix.$name.'_error"'.$markup.'>'.(isset($GLOBALS[$prefix.$name.'_error']) ? $GLOBALS[$prefix.$name.'_error'] : '').'</span>'; }
