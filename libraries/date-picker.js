			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!
						controller.button = $('<a href="#" class="dp-choose-date" title="' + $.dpText.TEXT_CHOOSE_DATE + '"><img style="height: 1.5em; vertical-align: middle;" alt="' + $.dpText.DATE_PICKER_ALT + '" src="' + $.dpText.DATE_PICKER_URL + '" /></a>')
								.bind(
									'click',
									function()
									{
		...
		{	
			...
			setDisabled : function(s)
			{
				...
				if (this.button) {
					...
					$but.attr('title', s ? '' : $.dpText.DATE_PICKER_URL);
				}
				if ($e.is(':text')) {
