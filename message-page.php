...
<?php if ((!isset($_GET['id'])) && (!isset($_POST['submit']))) {
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="form_id" id="form_id" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/30)))+'em';" onblur="this.style.height = '1.75em';" cols="25" onchange="fill_form(this.form);"><?php echo $_POST['form_id']; ?></textarea>
<?php $description = ($_POST['form_id'] == 0 ? __('No form', 'contact-manager') : htmlspecialchars(contact_excerpt(contact_form_data(array(0 => 'name', 'id' => $_POST['form_id'])), 50)));
$result = ((isset($GLOBALS['contact_form'.$_POST['form_id'].'_data'])) && (isset($GLOBALS['contact_form'.$_POST['form_id'].'_data']['id'])));
if ((!$result) && ($_POST['form_id'] > 0)) { $description = __('Inexistent or deleted form', 'contact-manager'); }
...
echo '<br />'.($result ? '<a style="text-decoration: none;" '.$ids_fields_links_markup.' href="admin.php?page=contact-manager-form&amp;id='.$_POST['form_id'].'">'.__('Edit', 'contact-manager').'</a>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="receiver" id="receiver" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/90)))+'em';" onblur="this.style.height = '1.75em';" cols="75" onchange="fill_form(this.form);"><?php echo $_POST['receiver']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="subject" id="subject" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/90)))+'em';" onblur="this.style.height = '1.75em';" cols="75" onchange="fill_form(this.form);"><?php echo $_POST['subject']; ?></textarea></td></tr>
...
<td><textarea style="float: left; margin-right: 1em; width: 75%;" name="content" id="content" rows="10" cols="75" onchange="fill_form(this.form);"><?php echo $_POST['content']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="first_name" id="first_name" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['first_name']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="last_name" id="last_name" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['last_name']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="website_name" id="website_name" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['website_name']; ?></textarea> 
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="website_url" id="website_url" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/90)))+'em';" onblur="this.style.height = '1.75em';" cols="75" onchange="fill_form(this.form);"><?php echo $_POST['website_url']; ?></textarea> 
<?php $url = htmlspecialchars(message_data(array(0 => 'website_url', 'part' => 1, 'id' => (isset($_GET['id']) ? $_GET['id'] : 0)))); if ($url != '') { ?><a style="vertical-align: 25%;" <?php echo $urls_fields_links_markup; ?> href="<?php echo $url; ?>"><?php _e('Link', 'contact-manager'); ?></a><?php } ?></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="address" id="address" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['address']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="postcode" id="postcode" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['postcode']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="town" id="town" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['town']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="country" id="country" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['country']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="phone_number" id="phone_number" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['phone_number']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="ip_address" id="ip_address" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/60)))+'em';" onblur="this.style.height = '1.75em';" cols="50" onchange="fill_form(this.form);"><?php echo $_POST['ip_address']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="user_agent" id="user_agent" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/90)))+'em';" onblur="this.style.height = '1.75em';" cols="75" onchange="fill_form(this.form);"><?php echo $_POST['user_agent']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="referring_url" id="referring_url" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/90)))+'em';" onblur="this.style.height = '1.75em';" cols="75" onchange="fill_form(this.form);"><?php echo $_POST['referring_url']; ?></textarea> 
...
<td><textarea style="padding: 0 0.25em; '.($rows == 1 ? 'height: 1.75em; ' : '').'width: 75%;" name="custom_field_'.$key.'" id="custom_field_'.$key.'" rows="'.$rows.'" cols="75" onchange="fill_form(this.form);">'.htmlspecialchars($field_value).'</textarea>'
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="referrer" id="referrer" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/30)))+'em';" onblur="this.style.height = '1.75em';" cols="25" onchange="fill_form(this.form);"><?php echo $_POST['referrer']; ?></textarea>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="commission_amount" id="commission_amount" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/30)))+'em';" onblur="this.style.height = '1.75em';" cols="25" onchange="fill_form(this.form);"><?php echo number_format($_POST['commission_amount'], 2, '.', ''); ?></textarea> <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span> 
...
<td><select name="commission_status" id="commission_status" onchange="if (this.value == 'paid') { document.getElementById('commission-payment-date').style.display = ''; } else { document.getElementById('commission-payment-date').style.display = 'none'; } fill_form(this.form);">
...
<td><input class="date-pick" type="text" name="commission_payment_date" id="commission_payment_date" size="20" value="<?php echo $_POST['commission_payment_date']; ?>" onchange="fill_form(this.form);" />
<?php if ($_POST['commission_payment_date'] == '') { echo '<br /><span class="description noscript">'.__('Leave this field blank if the commission is not paid, or for the current date if the commission is paid.', 'contact-manager').'</span>'; } ?></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="referrer2" id="referrer2" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/30)))+'em';" onblur="this.style.height = '1.75em';" cols="25" onchange="fill_form(this.form);"><?php echo $_POST['referrer2']; ?></textarea>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="commission2_amount" id="commission2_amount" rows="1" onfocus="this.style.height = (1.75*Math.min(5, 1 + Math.floor(this.value.length/30)))+'em';" onblur="this.style.height = '1.75em';" cols="25" onchange="fill_form(this.form);"><?php echo number_format($_POST['commission2_amount'], 2, '.', ''); ?></textarea> <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span> 
<?php if (!isset($_GET['id'])) { echo '<span class="description noscript" style="vertical-align: 25%;">'.__('Leave this field blank to automatically calculate the amount.', 'contact-manager').'</span>'; } ?></td></tr>
...
<td><select name="commission2_status" id="commission2_status" onchange="if (this.value == 'paid') { document.getElementById('commission2-payment-date').style.display = ''; } else { document.getElementById('commission2-payment-date').style.display = 'none'; } fill_form(this.form);">
...
<td><input class="date-pick" type="text" name="commission2_payment_date" id="commission2_payment_date" size="20" value="<?php echo $_POST['commission2_payment_date']; ?>" onchange="fill_form(this.form);" />
<?php if ($_POST['commission2_payment_date'] == '') { echo '<br /><span class="description noscript">'.__('Leave this field blank if the commission is not paid, or for the current date if the commission is paid.', 'contact-manager').'</span>'; } ?></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php echo (isset($_GET['id']) ? __('Update', 'contact-manager') : __('Save', 'contact-manager')); ?>" /></td></tr>
</tbody></table>
</div>
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="message_confirmation_email_sent" id="message_confirmation_email_sent" value="yes"<?php if ($_POST['message_confirmation_email_sent'] == 'yes') { echo ' checked="checked"'; } ?> /> <strong><?php _e('Send a message confirmation email', 'contact-manager'); ?></strong></label></td></tr>
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="message_notification_email_sent" id="message_notification_email_sent" value="yes"<?php if ($_POST['message_notification_email_sent'] == 'yes') { echo ' checked="checked"'; } ?> /> <strong><?php _e('Send a message notification email', 'contact-manager'); ?></strong></label></td></tr>
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="commerce_registration_confirmation_email_sent" id="commerce_registration_confirmation_email_sent" value="yes"<?php if ($_POST['commerce_registration_confirmation_email_sent'] == 'yes') { echo ' checked="checked"'; } ?> /> <?php _e('Send a registration confirmation email', 'contact-manager'); ?></label><br />
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="commerce_registration_notification_email_sent" id="commerce_registration_notification_email_sent" value="yes"<?php if ($_POST['commerce_registration_notification_email_sent'] == 'yes') { echo ' checked="checked"'; } ?> /> <?php _e('Send a registration notification email', 'contact-manager'); ?></label><br />
...
$url = 'admin.php?page=membership-manager';
if (is_numeric($_POST['sender_members_areas'])) {
$description = ($_POST['sender_members_areas'] == 0 ? __('All members areas', 'contact-manager') : htmlspecialchars(contact_excerpt(member_area_data(array(0 => 'name', 'id' => $_POST['sender_members_areas'])), 50)));
$result = ((isset($GLOBALS['member_area'.$_POST['sender_members_areas'].'_data'])) && (isset($GLOBALS['member_area'.$_POST['sender_members_areas'].'_data']['id'])));
if ((!$result) && ($_POST['sender_members_areas'] > 0)) { $description = __('Inexistent or deleted member area', 'contact-manager'); }
if ($description != '') { echo '<span class="description" style="vertical-align: 25%;">('.$description.')</span>'; }
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="membership_registration_confirmation_email_sent" id="membership_registration_confirmation_email_sent" value="yes"<?php if ($_POST['membership_registration_confirmation_email_sent'] == 'yes') { echo ' checked="checked"'; } ?> /> <?php _e('Send a registration confirmation email', 'contact-manager'); ?></label><br />
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="membership_registration_notification_email_sent" id="membership_registration_notification_email_sent" value="yes"<?php if ($_POST['membership_registration_notification_email_sent'] == 'yes') { echo ' checked="checked"'; } ?> /> <?php _e('Send a registration notification email', 'contact-manager'); ?></label><br />
