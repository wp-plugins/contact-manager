...
if ($_POST['form_id'] > 0) { $GLOBALS['contact_form_data'] = (array) $wpdb->get_row("SELECT * FROM ".$wpdb->prefix."contact_manager_forms WHERE id = ".$_POST['form_id'], OBJECT); }
...
$GLOBALS['message_data']['id'] = '{message id}';
if ($_POST['referrer'] != '') {
