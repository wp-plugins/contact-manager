...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="message_confirmation_email_sent" id="message_confirmation_email_sent" value="yes"<?php if ((isset($_POST['update_fields'])) && ($_POST['message_confirmation_email_sent'] == 'yes')) { echo ' checked="checked"'; } ?> /> <strong><?php _e('Send a message confirmation email', 'contact-manager'); ?></strong></label></td></tr>
...
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><label><input type="checkbox" name="message_notification_email_sent" id="message_notification_email_sent" value="yes"<?php if ((isset($_POST['update_fields'])) && ($_POST['message_notification_email_sent'] == 'yes')) { echo ' checked="checked"'; } ?> /> <strong><?php _e('Send a message notification email', 'contact-manager'); ?></strong></label></td></tr>
