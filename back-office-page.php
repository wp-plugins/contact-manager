...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="custom_icon_url" id="custom_icon_url" rows="1" cols="75" onchange="document.getElementById('custom-icon-url-link').href = kleor_format_url(this.value);"><?php echo $options['custom_icon_url']; ?></textarea> 
