...
function contact_fill_admin_page_fields() {
global $wpdb; $error = '';
...
$_POST = array(); foreach ($_GET as $key => $value) {
if (!in_array($key, array('action', 'key', 'page', 'submit', 'time'))) { $_POST[$key] = stripslashes($value); } }
$_POST['update_fields'] = 'yes';
...
contact_fill_admin_page_fields(); } } break;
